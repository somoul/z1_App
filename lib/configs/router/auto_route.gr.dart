...
import '../../modules/home/page/home_screen.dart' as _i11;
import '../../modules/profile/page/profile_screen.dart' as _i12;
import '../../modules/profile/page/viewprofile_screen.dart' as _i9;
import '../../modules/qr_screen/screen/qr_screen.dart' as _i4;
import '../../modules/scan_qp_code/scan_qr_code_screen.dart' as _i10;
...
import '../../utils/show_image_qrcode/qrcode.dart' as _i8;
...
class AppRouter extends _i13.RootStackRouter {
  ...
  final Map<String, _i13.PageFactory> pagesMap = {
    ...
    QrcodeScreen.name: (routeData) {
      return _i13.CustomPage<dynamic>(
          routeData: routeData,
          child: const _i8.QrcodeScreen(),
          opaque: true,
          barrierDismissible: false);
    },
    ViewProfile.name: (routeData) {
      return _i13.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i9.ViewProfile());
    },
    ScanQrCodeSceen.name: (routeData) {
      return _i13.MaterialPageX<dynamic>(
          routeData: routeData, child: const _i10.ScanQrCodeSceen());
    },
  ...
  List<_i13.RouteConfig> get routes => [
        ...
        _i13.RouteConfig(SplashScreen.name, path: '/slashScreen'),
        _i13.RouteConfig(SignInScreen.name, path: 'signInScreen'),
        _i13.RouteConfig(PinCodeScreen.name, path: 'pinCodeScreen'),
        _i13.RouteConfig(QrScreen.name, path: 'qrscreen'),
        _i13.RouteConfig(LoginQrCodeScreen.name, path: 'loginQrCodeScreen'),
        _i13.RouteConfig(OnboardingScreen.name, path: 'onboardingScreen'),
        _i13.RouteConfig(BottomBar.name, path: '', children: [
          _i13.RouteConfig('#redirect',
              path: '',
              parent: BottomBar.name,
              redirectTo: 'homeScreen',
              fullMatch: true),
          _i13.RouteConfig(ScanQrCodeSceen.name,
        ...
        _i13.RouteConfig(QrcodeScreen.name, path: 'qrcodeScreen'),
        _i13.RouteConfig(ViewProfile.name, path: 'viewProfile'),
        _i13.RouteConfig('*#redirect',
...
/// generated route for
/// [_i4.QrScreen]
class QrScreen extends _i13.PageRouteInfo<void> {
...
class LoginQrCodeScreen extends _i13.PageRouteInfo<void> {
...
/// generated route for
/// [_i8.QrcodeScreen]
class QrcodeScreen extends _i13.PageRouteInfo<void> {
...
/// generated route for
/// [_i9.ViewProfile]
class ViewProfile extends _i13.PageRouteInfo<void> {
...
/// generated route for
/// [_i10.ScanQrCodeSceen]
class ScanQrCodeSceen extends _i13.PageRouteInfo<void> {
